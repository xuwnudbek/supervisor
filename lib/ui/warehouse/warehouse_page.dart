                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        await Get.to(() => AddWarehouse(provider: provider))
                            ?.then((value) {
                          if (value == true) {
                            provider.initialize();
                          }
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child:
                                            (provider.selectedWarehouse['stoks']
                                                        as List)
                                                    .isEmpty
                                                ? Center(
                                                    child: Text(
                                                        "Omborda maxsulotlar topilmadi"),
                                                  )
                                                : SingleChildScrollView(
                                                    scrollDirection:
                                                        Axis.horizontal,
                                                      ...
                                                      child: DataTable(
                                                        ...
                                                        columns: [
                                                          ...
                                                          DataColumn(
                                                            numeric: true,
                                                            tooltip:
                                                                "Ohirgi yangilanish bo'yicha tartiblash",
                                                            onSort: (index, _) {
                                                              provider.sortBy(
                                                                  index,
                                                                  'last_updated',
